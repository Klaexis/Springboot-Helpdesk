...
public class AdminTicketService {
    ...
    public Ticket assignTicket(Long ticketNumber, Long employeeId, String assignedBy) {
    ...
    public Ticket updateTicket(Long id, Ticket updatedTicket, String updatedBy) {
    ...
    public Ticket updateTicketStatus(Long ticketNumber, TicketStatus newStatus, String updatedBy) {
        Ticket ticket = ticketRepository.findById(ticketNumber)
                .orElseThrow(() -> new RuntimeException("Ticket not found"));
